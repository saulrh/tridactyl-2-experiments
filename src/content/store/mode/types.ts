...
export type ModeActionTypes = ChangeModeAction | RotateModeAction;

export const MODE_NORMAL = 'normal';
export const MODE_IGNORE = 'ignore';

export type Mode = typeof MODE_NORMAL | typeof MODE_IGNORE;

export interface ModeStateInterface {
  readonly mode: Mode;
}
export type ModeState = immutable.RecordOf<ModeStateInterface>;
